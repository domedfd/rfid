            ...
            <div class="container-fluid">                
                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <div class="row">
                           <div class="col-lg-12">
                               <div class="form-group pull-left">                                    
                                   <?php echo '<a href="add_new_admin.php?menu_id='. $menu_id . '&action_id='. $action_id .'&add=True" class="btn btn-primary btn-sm" role="button">Adicionar</a>';?>
                               </div>      
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <!--<h2><small>Usuários Cadastrados do Sistema</small></h2><br>-->
                                <div class="table-responsive">
									<?php get_all_admin($connection, $menu_id, $action_id);?>
                                </div>
                            </div>
                            <!-- /.col-lg-12 -->
                        </div>
