                            ...
                            <div class="col-lg-12">
								<div class="form-group pull-left">  
                                    ...
                                    if(isset($_GET['add']) || isset($_GET['edit'])){
										echo '<button type="submit" class="btn btn-success btn-sm" name="submit" form="save_admin">Salvar</button>';	
									}
                                    else{
										echo '<a href="?menu_id=' . $menu_id . '&action_id=' . $action_id . '&admin_id=' . $admin_id . '&edit=true" class="btn btn-warning btn-sm" role="button">Editar</a>';
									...
									<?php
										if($edit=='true'){
										    echo '<a href="add_new_admin.php?menu_id=' . $menu_id . '&action_id=' . $action_id . '&admin_id=' . $admin_id . '" class="btn btn-default btn-sm" role="button">Cancelar</a>';
										}
										if($add=='True'){
                                            ...
                                            <div class="col-lg-8 col-md-offset-2"> 
												...
												<div class="panel panel-default">
                                                    ...
                                                    <div class="panel-body">
                                                        <div class="row">
                                                            <div class="col-md-12">
                                                                <form action="save_new_admin.php?menu_id=<?php echo $menu_id . '&action_id='. $action_id . '&admin_id=' . $admin_id; ?>" method="POST" id="save_admin"  class="form-horizontal" accept-charset="UTF-8">
                                                                    <div class="row">
                                                                        <div class="col-md-6">
                                                                            <fieldset>
                                                                                <!-- Form Name -->
...
Dados pessoais</h4></legend>   
                                                                                ...
                                                                                <div class="form-group">
                                                                                    ...
                                                                                    <div class="col-md-9">
                                                                                        <div class='input-group username' id='username'>
																						  <input type="text" class="form-control input-sm" required id="username" value="<?php echo $username; ?>" name="username" <?php if($edit != 'true' && $add!='True') echo 'disabled'; ?>/> 
                                                                                ...
                                                                                <div class="form-group">
                                                                                    <label class="col-md-3 control-label" for="selectbasic">Senha:</label>
                                                                                    <div class="col-md-9">
                                                                                        <div class='input-group password' id='password'>
                                                                                          <input type="text" class="form-control input-sm" required id="password" value="<?php echo $password; ?>" name="password" <?php if($edit != 'true' && $add!='True') echo 'disabled'; ?>/> 
                                                                                         <span class="input-group-addon">
                                                                                            <span placeholder class="glyphicon glyphicon-user"></span>
                                                                                         </span>
                                                                                       </div>
																				...
																				<div class="form-group">										<label class="col-md-3 control-label" for="textinput">Foto:</label> 
																					<div class="col-md-9">
	...
	$(function(){
		$('#deleteBtn').click(function(e){
			e.preventDefault();
			window.location.href = ' <?php echo 'delete_admin.php?menu_id=' . $menu_id . '&action_id=' . $action_id . '&admin_id='. $admin_id ?>';
		});
	});
