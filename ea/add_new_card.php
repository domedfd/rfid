                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="form-group pull-left">  
                                    ...
                                    ?>
                                    <?php 
                                        echo '<a href="delete_card.php?menu_id=' . $menu_id . '&action_id=' . $action_id .  '&delate=new" class="btn btn-default btn-sm" role="button">Cancelar</a>';
                                    ?>
                                </div>							
                                                                ...
                                                                <form action="save_new_card.php?menu_id=<?php echo $menu_id . '&action_id='. $action_id; ?>" method="POST" id="save_card"  class="form-horizontal" accept-charset="UTF-8">
                                                                    <div class="row">
                                                                        <div class="col-md-6">
                                                                            <fieldset>
                                                                                <!-- Form Name -->
                                                                                <legend><h4>Status do Cartão</h4></legend>   
                                                                                <!-- Select Basic -->
                                                                                <div class="form-group">
                                                                                    <label class="col-md-3 control-label" for="selectbasic">ID do Cartão:</label>
                                                                                    <div class="col-md-9">
                                                                                ...
                                                                                <div class="form-group">
                                                                                    <label class="col-md-3 control-label" for="textinput">Horário:</label>  
                                                                                    <div class="col-md-9">
                                                                                        <p class="form-control-static"><?php echo $date = date("H:i:s"); ?></p>
                                                                                    </div>
                                                                                </div>
                                                                        </div>
                                                                        ...
                                                                        <div class="col-md-6">
                                                                            <fieldset>
                                                                                ...
                                                                                <div class="form-group">
                                                                                    <label class="col-md-3 control-label" for="textarea">Comentar:</label>
                                                                                    <div class="col-md-9">                     
