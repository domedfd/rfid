...
<head>
    ...
    <title>Accesso eletrônico </title>
    <!-- Bootstrap -->
...
<body>
    <div id="wrapper">
     ...
     <div id="sidebar-wrapper">
            ...
            <?php include_once('../config/time.php'); $data = date('d/m/Y'); echo $data .' '.date('H:i:s'); ?>
        </div>
        <!-- /#sidebar-wrapper -->
                    ...
                    <div class="col-lg-12">
                        <div class="row">
                            ...
                            <div class="col-xs-8 col-sm-6 col-md-4 col-lg-3 pull-right">
                                <div class="input-group input-group-sm">
                                    <input type="text" id="filter" class="form-control" placeholder="Procurar por...">
                        ...
                        <!--        -->
                                    ...
                                    <div class="btn-group pull-right">
                                        ...
                                        <?php echo '<a href="add_new_card.php?menu_id='. $menu_id . '&action_id='. $action_id .'&add=True" class="btn btn-primary btn-sm" role="button">Adicionar</a>';?>               
                                    </div>
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <!--<h3><small>Administrar Cartões</small></h3>-->
                            </div>
                        </div>
									...
									<div class="col-md-12">
										<div class="panel panel-default">
											<div class="panel-heading">
												<a href="#" data-toggle="collapse" data-target="#" aria-expanded="true" class="panel-link"> Cartões registrados <span class="label label-success"><?php active_cards_count($connection); ?></span></a>
                                            </div>
                            ...
                            <div class="col-lg-6 col-md-12 col-sm-12">
								<div class="row">
									<div class="col-md-12">
										<div class="panel panel-default">
											<div class="panel-heading">
												<a href="#" data-toggle="collapse" data-target="#improvementsPanel_01" aria-expanded="true" class="panel-link">Cartões novos<span class="label label-warning"><?php new_cards_count($connection); ?></span></a>
											</div>
								...
								<div class="row">
									<div class="col-md-12">
										<div class="panel panel-default">
											<div class="panel-heading">
												<a href="#" data-toggle="collapse" data-target="#improvementsPanel_02" aria-expanded="true" class="panel-link">Cartões bloqueados  <span class="label label-danger"><?php block_cards_count($connection); ?></span></a>
											</div>
