            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                              <!--  <div class="form-group pull-left"> 
                                    <button type="submit" class="btn btn-success btn-sm" name="submit" form="add_user">Salvar</button>
                                    <a href="#" class="btn btn-default btn-sm" role="button">Cancelar</a>
                                    <a href="#" class="btn btn-primary btn-sm" role="button">Add usúario</a>   
                               </div>
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <!--<h3><small>Accesso Logs</small></h3><br>-->
									<?php
