...
if($employee_id != Null){
	echo "ganaxele";
	$query = 'UPDATE employee SET `name` = "' .  $employee . '", `date` = "'. $date. '", `telephone` = "' . $tel. '", `email` = "'. $mail. '", `foto` = "'. $foto. '"  WHERE id ='. $employee_id. ';';
	echo $query;
...
if($employee_id == Null){
	echo "axali";
	$query = 'INSERT INTO employee (`name`, `date`, `telephone`, `email`, `foto`) VALUES ("'. $employee . '","'. $date .'","' . $tel . '","'. $mail . '","'. $foto . '");';
